// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties13
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties13#deploy_0
    RETURN
    ** label2
