// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit4
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit4#deploy_0
    RETURN
    ** label2
