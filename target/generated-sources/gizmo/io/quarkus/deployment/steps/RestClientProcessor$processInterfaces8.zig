// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces8
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces8#deploy_0
    RETURN
    ** label2
