// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean7
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean7#deploy_0
    RETURN
    ** label2
