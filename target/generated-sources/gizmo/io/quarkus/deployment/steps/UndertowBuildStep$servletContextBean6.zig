// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean6
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean6#deploy_0
    RETURN
    ** label2
