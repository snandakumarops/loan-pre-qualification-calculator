// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces6
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces6#deploy_0
    RETURN
    ** label2
