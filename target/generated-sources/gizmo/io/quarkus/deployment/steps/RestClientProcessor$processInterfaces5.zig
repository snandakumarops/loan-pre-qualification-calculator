// Class: io/quarkus/deployment/steps/RestClientProcessor$processInterfaces5
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/RestClientProcessor$processInterfaces5#deploy_0
    RETURN
    ** label2
