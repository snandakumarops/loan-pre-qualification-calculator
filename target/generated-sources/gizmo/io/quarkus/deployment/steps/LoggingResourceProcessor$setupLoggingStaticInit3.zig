// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit3
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit3#deploy_0
    RETURN
    ** label2
