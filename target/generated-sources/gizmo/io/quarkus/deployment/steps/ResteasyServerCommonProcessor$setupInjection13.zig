// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection13
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection13#deploy_0
    RETURN
    ** label2
