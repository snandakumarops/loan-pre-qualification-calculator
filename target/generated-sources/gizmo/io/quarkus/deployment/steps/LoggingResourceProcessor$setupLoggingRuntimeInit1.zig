// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingRuntimeInit1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingRuntimeInit1#deploy_0
    RETURN
    ** label2
